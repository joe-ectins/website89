...
const COUNTDOWN_FROM = "2025-02-28";
...
const CountdownItem = ({ unit, text }: CountdownItemProps) => {
	...
	return (
		<div className="flex h-24 w-1/4 flex-col items-center justify-center gap-1 border-r-[1px] border-zinc-300 dark:border-zinc-800 font-mono md:h-36 md:gap-2">
			<div className="relative w-full overflow-hidden text-center">
				<span
					ref={ref}
					className="block text-2xl font-medium text-black dark:text-white md:text-4xl lg:text-6xl xl:text-7xl">
					{time}
				</span>
			</div>
